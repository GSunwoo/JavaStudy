...
//		MyC refId3 = refId1;
		/*
		refd1은 MyC 인스턴스를 참조하지만, 원래 MyA 타입이므로
		myC타입이라 착각하면 안된다. 해피해피해피나루나는해피나루*/
		
		/*
		자식으로 부모 인스턴스를 참조하는것은 기본적으로 불가능하다.
		하지만 다운캐스팅(강제형변환)을 하면 참조가 가능해진다.
		즉 부모타입을 자식타입으로 변경하는 것이다. 이는 클래스가 상속관계에
