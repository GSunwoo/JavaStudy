...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter format3 = 
				DateTimeFormatter.ofPattern("오늘은 M월의 W번째주, d번째날, F번째 E요일");
		...
		System.out.println("3일후 : " + monent.plusDays(3).format(format1));
		System.out.println("2개월후 : " + monent.plusMonths(2).format(format1));
		System.out.println("1년후 : " + monent.plusYears(1).format(format1));
		// 메서드 체인 형식으로 연속해서 호출할 수 있다.
		System.out.println("1년2개월3일후 : " + 
				monent.plusYears(1).plusMonths(2).plusDays(3).format(format1));
	}
