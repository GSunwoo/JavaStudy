...
/*
Wrapper 클래스
: 기본자료형의 데이터를 인스턴스화 할때 사용하는 클래스로 Boxing/Unboxing을 통해 기본자료형의 데이터를
...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		JDK 최신버전에서는 디플리케이트 되어 사용되지 않는 생성자라는 경고 메세지가 출력된다.
		구 버전과의 호환성을 위해 남겨져 있는 상태이다.
		 */
		// 정수를 구버전의 생성자를 이용해서 Boxing처리
		...
		System.out.println("결과값을 이진수로 변경 : " +
				resultObj.toBinaryString(result2));
		
		/*
		최신버전에서의 코딩형태
		오토박싱/언박싱이 지원되므로 기본자료형 변수를 선언하는 것과 동일하게 코딩할 수 있다.
		 */
