...
구성관계란 클래스의 멤버로 다른 클래스의 인스턴ㅅ를 사용하는 것을 말한다. */
...
class Police {
	...
	public Police(int bNum, int hCuff) {
		//수갑은 단순한 정수값을 통해 보유 여부 설정
		handCuffs = hCuff;
		/*
		권총의 보유어부는 탄혼이 없는 상태라면 null로 초기화한다.
