...
단, 클래스 외부에서 접근할 때는 인스턴스 생성없이 클래스명을 통해 접근할 수 있다
...
class Adder {
	...
	/*
	static으로 선언된 멤버변수는 실제오 클래스 외부(Method영역)에
...
/*
부모의 멤버변수가 public이므로 접근의 제한이 없다. 따라서 자식 ㅡㄹ래스에
...
public class E03StaticInheritance {
	...
	public static void main(String[] args) {
		...
		val에 더해지게 되므로 출력결과는 20이 된다. 뿌뿌뿡*/
		ad.add(1);
