...
public class Korea {
	...
	//4가지의 접근지정자를 통해 멤버메서드 정의ㅓ
	public void publicMethod(String loc) {
		/*
		prblic으로 선언된 멤버메서드는 어디서든 접근이 가능하다.
		동일패키지, 다른 패키지, 외부클래스, 상속 등 모든 영역에서
		접근할 수 있다.
		 */
	...
	protected void protectedMethod(String loc) {
		/*
		서로 패키지가 다른 3개의 클래스가 상속관게를 가지고있다면
	...
	void defaultMethod(String loc) {
		/*
		패키지가 동일하때만 접근을 허용한다. 패키지가 다른 경우
		상속관계가 아니라면 public으로 선언해야 접근할 수 있다. */
